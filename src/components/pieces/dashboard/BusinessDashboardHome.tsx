      ...
      <div className="w-full space-y-5">
        <motion.section initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: .35 }} className="relative min-h-[21rem] overflow-hidden rounded-[2rem] bg-[#04162f] text-white shadow-[0_18px_50px_rgba(4,22,47,.18)]">
          ...
          <div className="relative grid min-h-[21rem] items-end gap-8 p-5 sm:p-8 lg:grid-cols-[minmax(0,1.3fr)_minmax(18rem,.7fr)] lg:p-10">
            ...
            <div className="mt-5 flex flex-wrap gap-2"><Button className="rounded-full bg-white text-[#071b31] hover:bg-white/90" onClick={() => navigate('/app/agents')}><Search size={16} /> Find a verified sourcing agent</Button><Button variant="outline" className="rounded-full border-white/20 bg-white/[.07] text-white hover:bg-white/15 hover:text-white" onClick={() => navigate('/app/market')}>Browse China wholesale <ArrowRight size={15} /></Button></div>
            </div>
