...
const SHORT_LABELS: Record<string, string> = {
  'supplier-purchase': 'Buy stock',
  'wholesale-order': 'Wholesale order',
  'service-delivery': 'Pay for a service',
  'contractor-engagement': 'Hire a contractor',
  'equipment-purchase': 'Buy equipment',
  'custom-business-deal': 'Something else',
  'property-agent-payments': 'Property purchase',
  ...
  'vehicle-transactions': 'Vehicle purchase',
