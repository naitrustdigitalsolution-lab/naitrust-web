  ...
  return (
    <div className="relative min-w-0 w-full">
      <div className="grid place-items-center px-2 lg:place-items-start lg:px-0">
        ...
        >
          <h1 className={`naitrust-satoshi-bold w-full max-w-3xl text-center text-[clamp(1.55rem,7.5vw,1.9rem)] leading-[1.04] tracking-[-0.04em] text-white sm:text-[clamp(2.5rem,8vw,4.25rem)] sm:leading-[0.96] sm:tracking-[-0.055em] md:text-[clamp(3rem,7vw,4.25rem)] xl:text-left ${compact ? 'xl:text-[clamp(2.75rem,3.5vw,4rem)]' : 'xl:text-[clamp(3.15rem,4.6vw,5rem)]'}`}>
