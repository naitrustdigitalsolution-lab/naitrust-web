  ...
  return (
    <Card className="gap-0 overflow-hidden rounded-3xl p-0 shadow-sm">
      <div className="flex items-center justify-between border-b px-5 py-4 sm:px-6">
        <div><h2 className="font-semibold">Completed trade</h2><p className="mt-0.5 text-xs text-muted-foreground">Your finished orders and marketplace payments with this contact.</p></div>
      ...
      {transactions.length === 0 ? (
        <div className="flex flex-col items-center px-6 py-12 text-center">
          ...
          <p className="mt-1 max-w-sm text-xs leading-5 text-muted-foreground">Completed orders and eligible marketplace payments with this contact will be recorded here.</p>
        </div>
